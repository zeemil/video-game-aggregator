    ...
    <div class="container mx-auto px-4">
        <div class="game-details border-b border-gray-800 pb-12 flex flex-col lg:flex-row">
            ...
            <div class="lg:ml-12 lg:mr-64">
                <h2 class="font-lg:semibold text-4xl leading-tight mt-1">{{ $game['name'] }}</h2>
                ...
                <div class="flex flex-wrap items-center mt-8">
                    ...
                    <div class="social-icons flex items-center space-x-4 mt-4 lg:mt-0 lg:ml-12">
...
{{--                    </button>--}}
                    <a href="https://youtube.com/watch/{{$game['videos'][0]['video_id']}}" class="inline-flex bg-blue-500 text-white font-semibold px-4 py-4 hover:bg-blue-600 rounded transition ease-in-out duration-150" target="_blank">
                        <svg class="w-6 fill-current" viewBox="0 0 24 24">
                            <path d="M0 0h24v24H0z" fill="none"></path>
                            <path d="M10 16.5l6-4.5-6-4.5v9zM12 2C6.48 2 2 6.48 2 12s4.48 10 10 10 10-4.48 10-10S17.52 2 12 2zm0 18c-4.41 0-8-3.59-8-8s3.59-8 8-8 8 3.59 8 8-3.59 8-8 8z"></path>
                        </svg>
        ...
        <div class="images-container border-gray-800 pb-12 mt-8">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-12 mt-8">
                @foreach($game['screenshots'] as $screenshot)
                    <div>
                        <a href="#">
                            <img src="{{ Str::replaceFirst('thumb', 'screenshot_huge',$screenshot['url']) }}" alt="screenshot"
                ...
                <div class="game mt-8">
                    ...
                    <div class="text-gray-400 mt-1">
                        @if(isset($similar_game['platforms']))
                            @foreach($similar_game['platforms'] as $plateform)
                                @if(array_key_exists('abbreviation', $plateform))
                                    {{ $plateform['abbreviation'] }},
                                @endif
                            @endforeach
